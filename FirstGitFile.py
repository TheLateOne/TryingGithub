...
for i in listofstudents[:len(listofstudents)-1]:
    ...
    for p in listofstudents[countI:]:
        countP += 1
        if i == p:
            print "{}, person {}'s birthday is equal to {} person {}'s birthday".format(i,countI,p,countP)
            occurrences += 1
print "The total number of occurrences is {} over the course of {} students.".format(occurrences, numberofstudents)
